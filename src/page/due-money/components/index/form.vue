            ...
            <div class="purchase-order-form-list form-pd">
                <div class="flex purchase-order-form-item">
                    <div class="form-group flex flex-y-center">
                        <span class="form-name">应付款编号</span>
                        <el-input class="form-group-input" v-model="formInline.poNum" placeholder="请输入应付款编号"></el-input>
                    </div>
                    <div class="form-group flex flex-y-center">
                        <span class="form-name">应付日期</span>
                        <el-date-picker
                ...
                <div class="flex purchase-order-form-item">
                    ...
                    <div class="form-group flex flex-y-center">
                        <span class="form-name">发票号</span>
                        <el-input class="form-group-input" v-model="formInline.poNum" placeholder="请输入发票号"></el-input>
                    </div>
                </div>
            </div>
